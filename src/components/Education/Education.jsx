...
const Education = () => {
  return (
    <div id='education' className='flex flex-col bg-black p-4 pb-36 border-b border-blue-300'>
      <div className='text-white text-3xl md:text-5xl lg:text-7xl flex justify-center mt-12 md:mt-20 lg:mt-28 pb-4 md:pb-6 lg:pb-9'>
        <h1 className='bg-gradient-to-r from-blue-300 via-blue-600 to-blue-700 text-transparent bg-clip-text'>
          Education
        </h1>
      </div>
      <div className='flex flex-col justify-center items-center bg-black z-10'>
        <div className='border-2 border-blue-400 bg-gradient-to-r from-blue-300 via-blue-500 to-blue-700 shadow-white rounded-2xl w-full md:w-4/5 lg:w-3/5 p-4'>
          <div className='flex flex-col gap-4 md:gap-6'>
            <div className='flex flex-col md:flex-row justify-center md:justify-between items-center px-2 md:px-6 lg:px-10 pt-4 md:pt-8 lg:pt-12'>
            ...
            <div className='text-section px-2 md:px-6 lg:px-12'>
              ...
              <div className='location-uni flex flex-col gap-4 md:gap-6 lg:gap-8'>
                <div className='university-section flex items-center gap-3 md:gap-4 lg:gap-5'>
                  <div className='bg-white p-1 rounded-full'>
                    <img src="./src/assets/school.png" alt="university" className='w-4 h-6 md:w-5 md:h-7 lg:w-6 lg:h-8'/>
                  </div>
                ...
                <div className='location-section flex items-center gap-3 md:gap-4 lg:gap-5'>
                  <div className='bg-white p-1 rounded-full'>
                    <img src="./src/assets/map.png" alt="location" className='w-4 h-6 md:w-5 md:h-7 lg:w-6 lg:h-8'/>
                  </div>
                  <div className='text-sm md:text-base lg:text-lg leading-5 md:leading-6 lg:leading-7 font-bold'>
