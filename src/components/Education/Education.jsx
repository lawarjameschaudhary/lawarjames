...
const Education = () => {
  return (
    <div id='education' className='flex flex-col px-2 bg-black pb-20 border-b-[0.1px] border-blue-300'>
      ...
      <div className='flex flex-col justify-center mt-8 sm:mt-28 items-center bg-black'>
