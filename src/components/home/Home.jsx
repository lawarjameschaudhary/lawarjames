  ...
  const Home = ({ scrollToSection }) => {
    return (
      <div className='bg-[url(./src/assets/bg.jpg)] bg-cover bg-center text-white font-Fanta leading-9  pl-12 pr-12 pt-20 xl:pt-52 md:pt-40 border-b-[0.1px] border-blue-300 pb-20'>
